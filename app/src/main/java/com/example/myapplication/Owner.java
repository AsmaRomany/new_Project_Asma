...
public class Owner extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private Button button,button2,button_add;
...
//        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in2;
                in2 = new Intent(Owner.this, Registration.class);
                startActivity(in2);
                finish();
            }
        });
                    ...
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            if (document != null && document.exists()) {
                                ...
                                Toast.makeText(Owner.this, "User document does not exist", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            // Error retrieving user data
                            Toast.makeText(Owner.this, "Error retrieving user data", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            Toast.makeText(Owner.this, "No user logged in", Toast.LENGTH_SHORT).show();
        }
//                        }else {
//                            // Error retrieving user data
...
//                        }
    ...
    private void showProfile(FirebaseUser firebaseUser) {
        ...
        reference.child("Owner").child(userId);
...
//                        textView.setText(Name);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Owner.this, "Somthing Wrong...!", Toast.LENGTH_SHORT).show();
//                progressBar.setVisibility(View.GONE);
            }
        });
    }
                    ...
                    userRef.update("fullName", newName)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(Owner.this, "Name updated successfully", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Owner.this, "Failed to update name", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (currentUser != null) {
                    String userId = currentUser.getUid();
                    FirebaseFirestore db = FirebaseFirestore.getInstance();
                    DocumentReference userRef = db.collection("Owner").document(userId);
                    userRef.update("email", newEmail)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(Owner.this, "email updated successfully", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Owner.this, "Failed to update email", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
                ...
                if (currentUser != null) {
                    ...
                    userRef.update("location", newLocation)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(Owner.this, "location updated successfully", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Owner.this, "Failed to update location", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
                ...
                if (currentUser != null) {
                    ...
                    userRef.update("mobileNumber", newMobileNumber)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(Owner.this, "mobileNumber updated successfully", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Owner.this, "Failed to update mobileNumber", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
